...
class AuthApi {
  ...
  Future<Response<AuthenticationResponse>> callback({
    ...
    final _path = r'/auth/callback/{provider}'.replaceAll(
        '{' r'provider' '}',
  ...
  Future<Response<void>> login({
    ...
    final _path = r'/auth/login/{provider}'.replaceAll(
        '{' r'provider' '}',
        encodeQueryParameter(_serializers, provider, const FullType(String))
            .toString());
    final _options = Options(
  ...
  ///
  /// Parameters:
  /// * [refreshTokenParams] - User id and refresh token
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<AuthenticationResponse>> refreshToken({
    required RefreshTokenParams refreshTokenParams,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      ...
      _bodyData =
          _serializers.serialize(refreshTokenParams, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
