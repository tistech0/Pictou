...
class ImagesApi {
  ...
  Future<Response<void>> deleteImage({
    required String id,
    ...
    final _path = r'/images/{id}'.replaceAll(
        '{' r'id' '}',
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ImageMetaData] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ImageMetaData>> editImage({
    required String id,
    required ImagePatch imagePatch,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(ImagePatch);
      _bodyData = _serializers.serialize(imagePatch, specifiedType: _type);
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(ImageMetaData),
            ) as ImageMetaData;
    } catch (error, stackTrace) {
      throw DioException(
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ImagesMetaData] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ImagesMetaData>> getImages({
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(ImagesMetaData),
            ) as ImagesMetaData;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
    ...
    return Response<ImagesMetaData>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
