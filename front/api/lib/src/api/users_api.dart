...
import 'package:pictouapi/src/model/user_patch.dart';
...
class UsersApi {
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<User>> editSelf({
    required UserPatch userPatch,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      ...
      _bodyData = _serializers.serialize(userPatch, specifiedType: _type);
