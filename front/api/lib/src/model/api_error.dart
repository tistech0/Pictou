...
import 'package:pictou_api/src/model/api_error_code.dart';
...
abstract class ApiError implements Built<ApiError, ApiErrorBuilder> {
  ...
  // enum errorCodeEnum {  UNKNOWN,  QUERY_PAYLOAD_ERROR,  JSON_PAYLOAD_ERROR,  PATH_ERROR,  NOT_FOUND_ERROR,  UNAUTHORIZED_ERROR,  FORBIDDEN_ERROR,  MISSING_IMAGE_PAYLOAD,  IMAGE_PAYLOAD_TOO_LARGE,  UNSUPPORTED_IMAGE_TYPE,  INVALID_ENCODING,  READ_ONLY,  };
